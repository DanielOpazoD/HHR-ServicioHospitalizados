...
- Generated: 2026-04-22T03:16:20.812Z
...
| `src/shared/contracts/applicationOutcome.ts` | 1 | 55 | medium | 182 |
| `src/features/clinical-documents/domain/entities.ts` | 12 | 45 | high | 179 |
| `src/components/shared/BaseModal.tsx` | 6 | 46 | medium | 165 |
| `src/types/audit.ts` | 7 | 45 | medium | 164 |
| `src/types/authRoleTypes.ts` | 0 | 49 | medium | 162 |
...
| `src/context/AuthContext.tsx` | 12 | 34 | medium | 141 |
| `src/types/domain/laboratory.ts` | 8 | 34 | medium | 133 |
| `src/types/transfers.ts` | 6 | 35 | medium | 132 |
| `src/services/observability/operationalTelemetryOutcomeRecorder.ts` | 0 | 37 | high | 131 |
...
| `src/features/census/components/patient-row/patientRowViewContracts.ts` | 22 | 16 | high | 112 |
| `src/services/storage/indexeddb/indexedDbCore.ts` | 24 | 14 | high | 110 |
| `src/utils/clinicalDayUtils.ts` | 4 | 29 | medium | 110 |
| `src/features/census/contracts/censusMovementContracts.ts` | 1 | 29 | high | 109 |
| `src/services/observability/operationalTelemetryRecorder.ts` | 0 | 29 | high | 107 |
| `src/services/repositories/repositoryConfig.ts` | 9 | 23 | high | 107 |
| `src/services/staff/dailyRecordStaffing.ts` | 12 | 21 | high | 107 |
| `src/hooks/contracts/patientHookContracts.ts` | 3 | 28 | medium | 105 |
| `src/shared/access/operationalAccessPolicy.ts` | 9 | 24 | medium | 105 |
