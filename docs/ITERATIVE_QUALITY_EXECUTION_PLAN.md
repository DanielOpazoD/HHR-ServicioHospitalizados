...
| `Q02` | pendiente  | restaurar ownership y boundaries de `census`       |
| `Q03` | pendiente  | romper ciclos de `clinical-documents`              |
| `Q04` | pendiente  | alinear `repo-hygiene` y `domain-hotspot-boundary` |
...
| 2026-04-09 | `Q02` | pendiente  | Sin iniciar                                                                                          |
| 2026-04-09 | `Q03` | pendiente  | Sin iniciar                                                                                          |
| 2026-04-09 | `Q04` | pendiente  | Sin iniciar                                                                                          |
