...
describe('HandoffCalendarView', () => {
  ...
  describe('User interactions', () => {
    it('calls onDownload when download button is clicked', () => {
      const files: StoredPdfFile[] = [createMockFile('2026-01-01', 'day')];
  ...
  describe('Display formatting', () => {
    it('displays file size correctly', () => {
      const files: StoredPdfFile[] = [createMockFile('2026-01-01', 'day', 150000)];
  ...
  describe('Edge cases', () => {
    ...
    it('handles single file correctly', () => {
      const files: StoredPdfFile[] = [createMockFile('2026-01-01', 'night')];
