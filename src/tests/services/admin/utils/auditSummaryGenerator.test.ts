  ...
  describe('generateSummary', () => {
    describe('Patient actions', () => {
      ...
      it('should generate summary for PATIENT_VIEWED', () => {
        const summary = generateSummary('PATIENT_VIEWED', { patientName: 'Rosa Díaz' }, 'UTI-01');
    ...
    describe('Daily record actions', () => {
      it('should generate summary for DAILY_RECORD_CREATED', () => {
        const summary = generateSummary('DAILY_RECORD_CREATED', {}, '2026-01-15');
      ...
      it('should generate summary for DAILY_RECORD_DELETED', () => {
        const summary = generateSummary('DAILY_RECORD_DELETED', {}, '2026-01-15');
    ...
    describe('Bed actions', () => {
      ...
      it('should generate summary for BED_UNBLOCKED', () => {
        const summary = generateSummary('BED_UNBLOCKED', { bedId: 'UTI-05' }, 'UTI-05');
    ...
    describe('Default case', () => {
      it('should return action name for unknown actions', () => {
        const summary = generateSummary('UNKNOWN_ACTION' as AuditAction, {}, '');
        expect(summary).toBe('UNKNOWN_ACTION');
      });
    });

    describe('Maintenance actions', () => {
      it('should generate summary for DATA_ADMISSION_DATES_BACKFILLED', () => {
        const summary = generateSummary(
          'DATA_ADMISSION_DATES_BACKFILLED',
          { correctionCount: 7 },
          'historical-admission-dates'
        );
        expect(summary.toLowerCase()).toContain('fechas de ingreso');
