...
export type MedicalButtonVariant =
  | 'primary'
  | 'secondary'
  | 'ghost'
  | 'danger'
...
const variants: Record<MedicalButtonVariant, string> = {
  primary: 'bg-accent-600 text-white hover:bg-accent-700 shadow-md shadow-accent-200/50',
  ...
  outline: 'bg-transparent text-accent-600 border border-accent-200 hover:bg-accent-50',
};
