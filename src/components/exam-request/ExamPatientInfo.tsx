    ...
    <div className="border border-slate-400 p-1 mb-1">
      ...
      <div className="grid grid-cols-12 gap-x-4 border-b border-slate-200 pb-1 mb-1">
        ...
        <div className="col-span-5 flex gap-2">
          ...
          <div className="text-[17px] font-black text-slate-900 border-b border-slate-900 flex-1 h-6 px-1 uppercase leading-none">
            {patient.birthDate ? formatDateDDMMYYYY(patient.birthDate) : '-'}
          </div>
        </div>
      ...
      <div className="flex gap-2">
        ...
        <div className="text-[17px] font-black text-slate-900 border-b border-slate-900 flex-1 h-6 px-1 whitespace-nowrap overflow-hidden uppercase leading-none">
          {patient.pathology}
        </div>
      </div>
    </div>
