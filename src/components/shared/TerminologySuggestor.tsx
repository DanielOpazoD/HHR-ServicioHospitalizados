        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between text-[11px] font-medium uppercase tracking-wider">
            ...
            {aiEnabled === null ? (
              ...
              <span className="text-slate-400 bg-slate-100 px-2 py-1 rounded-full">Modo Local</span>
            )}
          </div>
          ...
          <div className="relative">
            ...
            {isLoading && (
              <Loader2
                className="absolute right-12 top-1/2 -translate-y-1/2 text-medical-500 animate-spin"
                size={18}
              />
            )}
            ...
            >
              <RefreshCw size={12} className={isLoading ? 'text-purple-300' : ''} />
              IA
            </button>
          </div>
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-sm text-slate-500 font-medium">
                  {query.length < 2
                    ...
                    : 'No se encontraron diagnósticos exactos.'}
                </p>
                <p className="text-xs text-slate-400 mt-1">
                  Pulse el botón <span className="text-purple-600 font-bold">IA</span> para una
                  búsqueda avanzada.
                </p>
              </div>
            )}
