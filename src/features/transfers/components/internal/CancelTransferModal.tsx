    ...
    >
      <div className="space-y-4">
        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-3 text-sm text-red-800">
          <strong>⚠️ Atención:</strong> Esta acción cancelará la solicitud de traslado. El paciente
          permanecerá hospitalizado y la cama no se liberará.
        </div>
        ...
        <div className="bg-slate-50 p-3 rounded-xl">
          ...
          <p className="text-sm text-slate-500 mt-1">
            Estado actual:{' '}
            <span className={TRANSFER_STATUS_CONFIG[transfer.status].color}>
