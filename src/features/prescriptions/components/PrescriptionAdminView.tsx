    ...
    return (
      <main data-module="prescriptions-admin" className="min-h-screen bg-slate-100 px-4 py-8">
        <div className="mx-auto max-w-md rounded-2xl border border-amber-200 bg-amber-50 p-6 text-center text-amber-900">
          ...
          <p className="mt-1 text-sm">Esta sección está disponible solo para administradores.</p>
        </div>
      </main>
    );
  }
      ...
      <div className="mx-auto max-w-3xl space-y-4">
        <header>
          ...
          <p className="text-xs text-slate-500">
            Administra el QR físico que se imprime en sala y el PIN compartido para subir recetas
            vía celular.
          </p>
        </header>
        ...
        >
          ...
          <p className="mb-4 text-xs text-slate-500">
            El PIN se entrega al equipo clínico. Cualquiera con el QR + PIN puede subir fotos. Tras
            5 fallos consecutivos el acceso se bloquea automáticamente por 15 minutos. Cambia el PIN
            periódicamente.
          </p>
