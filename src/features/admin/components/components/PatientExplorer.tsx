      ...
      <div className="border border-slate-200 rounded-xl overflow-hidden shadow-sm">
        <table className="w-full text-left text-xs">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              <th className="px-3 py-2 font-bold text-slate-500 uppercase tracking-widest text-[9px]">
                Paciente
              </th>
              <th className="px-3 py-2 font-bold text-slate-500 uppercase tracking-widest text-[9px]">
                RUT
              ...
              >
                <td className="px-3 py-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="font-bold text-slate-700 text-xs truncate max-w-[200px]">
                      {p.fullName}
                    </div>
                  </div>
                </td>
                <td className="px-3 py-1.5 font-mono text-[10px] text-slate-500">{p.rut}</td>
                <td className="px-3 py-1.5">
        ...
        {patients.length === 0 && !isLoading && (
          <div className="p-8 text-center bg-slate-50/50">
            ...
            <p className="text-sm text-slate-500 font-medium">
              No hay pacientes sincronizados en la base maestra.
            </p>
            <p className="text-xs text-slate-400">
              Ve a la pestaña de Sincronización para analizar el historial.
            </p>
          </div>
        )}
      </div>
