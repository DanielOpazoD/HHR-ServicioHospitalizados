...
export const actionIcons: Record<AuditAction, React.ReactNode> = {
  ...
  CONFLICT_AUTO_MERGED: <GitBranch size={14} />,
...
export const auditSections = {
  ...
  HANDOFF_NURSE: {
    ...
    actions: ['NURSE_HANDOFF_MODIFIED', 'VIEW_NURSING_HANDOFF'],
  },
  HANDOFF_MEDICAL: {
    label: 'Entrega Médica',
    color: 'bg-sky-100 text-sky-700',
    actions: ['MEDICAL_HANDOFF_MODIFIED', 'VIEW_MEDICAL_HANDOFF', 'HANDOFF_NOVEDADES_MODIFIED'],
  },
