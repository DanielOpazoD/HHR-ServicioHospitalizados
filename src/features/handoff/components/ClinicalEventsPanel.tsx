              ...
              {editingId === event.id ? (
                ...
                <div className="group relative bg-slate-50 px-2 py-1.5 rounded border border-slate-200 hover:border-slate-300 transition-colors">
                  <div className="flex-1 min-w-0">
                    ...
                    {event.note && (
                      <div
                        className="text-[10px] text-slate-500 mt-1 italic break-words line-clamp-2 leading-tight border-t border-slate-100 pt-1"
                        title={event.note}
                      >
                        {event.note}
                      </div>
    ...
    <div className="bg-blue-50 p-2 rounded border border-blue-200 space-y-2 shadow-sm animate-in fade-in zoom-in duration-200">
      ...
      <div className="flex min-w-0 gap-1.5">
        ...
        <input
          ...
          className="min-w-0 flex-1 w-full px-2 py-1 text-[10px] border border-slate-300 rounded focus:ring-1 focus:ring-medical-500 focus:border-medical-500 bg-white"
        />
      </div>
