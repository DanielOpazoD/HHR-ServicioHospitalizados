...
- Capas de z-index: backdrop `z-[34]`, wrapper `z-[35]`, acciones internas `z-10`. El launcher queda sobre el encabezado de la tabla (`z-30`) y bajo las barras sticky de navegación/fecha (`z-40`/`z-60`).
