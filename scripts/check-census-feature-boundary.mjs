...
const FEATURE_ROOT = path.normalize(path.join(ROOT, 'src', 'features', 'census'));
const PUBLIC_MODULES = new Set([
  '@/features/census',
  '@/features/census/index',
  '@/features/census/public',
]);
...
if (violations.length > 0) {
  console.error('\nCensus feature boundary violations:');
...
console.log('Census feature boundary checks passed.');
