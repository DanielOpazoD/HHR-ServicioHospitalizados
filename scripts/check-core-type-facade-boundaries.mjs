...
const RESTRICTED_IMPORTS = new Set(['@/types/core']);
const ALLOWED_IMPORTERS = new Set(['src/types/core.ts', 'src/types/index.ts']);
...
if (violations.length > 0) {
  console.error('\nCore type facade boundary violations:');
...
console.log('Core type facade boundary checks passed.');
